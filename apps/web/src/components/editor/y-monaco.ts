...
const createRelativeSelection = (editor: any, monacoModel: any, type: any) => {
...
const createMonacoSelectionFromRelativeSelection = (editor: any, type: any, relSel: any, doc: any) => {
...
export class MonacoBinding {
  ...
  constructor(ytext: Y.Text, monacoModel: monaco.editor.ITextModel, editors: Set<monaco.editor.IStandaloneCodeEditor> = new Set(), awareness: Awareness | null = null) {
      ...
      editors.forEach(editor => {
        if (awareness && editor.getModel() === monacoModel) {
          ...
          if (editor.createDecorationsCollection) {
             ...
             this._decorations.set(editor, (collection as any).getRanges().map((r: any) => r.toString()));
          } else {
             this._decorations.set(editor, editor.deltaDecorations(currentDecorations as any, newDecorations))
          }
        } else {
